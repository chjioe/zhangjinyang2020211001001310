<%@ page import="com.zhangjinyang.model.Order" %>
            ...
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <%
                        ...
                        com.zhangjinyang.userdao.UserDao userDao=new com.zhangjinyang.userdao.UserDao();
                    ...
                    <td class="cart_total">
                        <%
                            ...
                            String paymentType=com.zhangjinyang.model.Payment.findByPaymentId(con,n);
                        %>
